...
public class JDBCExaple1 {
	...
	public static void  main(String args[]) {
		...
		// 2. DBMS(oracle)
		// 3. Oracle에서 Java 애플리케이션과 연결할 때 사용할 JDBC를 상속 받아 구현할 클래스 모음(ojdbc11.jar 라이브러리)
		...
		// DB 연결 정보를 담은 객체
		// -> DBMS 타입, 이름, IP, Port, 게정명, 비밀번호 저장 
		...
		// 생성된 결과 (ResultSet, 성공한 행의 개수)를 반환(Jave)하는데 사용되는 객체
		...
		// --> 생략해도 자동으로 메모리 로드가 진행된다( 명시적으로 작성한는걸 권장)
		...
		// 3. SQL 작성 
		// ** JAVA에서 작성하는 SQL은 마지막에 ; 을 찍으면 안된다 **
